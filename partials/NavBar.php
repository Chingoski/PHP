    ...
    <div class="container">
        ...
        <div id="MenuItems" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="../Views/IndexView.php" class="nav-link">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="../Views/AboutView.php">About</a></li>
                <li class="nav-item"><a class="nav-link" href="../Views/ContactView.php">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>